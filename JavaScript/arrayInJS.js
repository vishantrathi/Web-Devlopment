const myArr = [0,1,2,3,4,5,6,70,8,9,true]  
//add true or eng word it is still a arr
//arr in js are scaleable
// console.log(myArr[7])

// const myarr1=["shaktimaan","nagraaj"]
// console.log(myarr1[0],myarr1[1])

//Methods of an array
//  myArr.push(6) //push element at last
//  myArr.pop() //remove last value
// myArr.unshift(9) //add element in front
// myArr.shift()

// console.log(myArr.includes(9)) //ans in true/false
...
const myn1=myArr.slice(0,6)
console.log(myn1)

const myn2=myArr.splice(0,6)
console.log(myn2)


// splice vs slice 
// the slice does not modify the the original array
//the splice modify the original array
